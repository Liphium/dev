...
description: "Different route variants in Neoroute."
---

# When to use which routing variant
There are 6 different routing variants. These are needed to ensure type safety, while supporting all request use cases.The table below lists all existing Route functions and their differences.
